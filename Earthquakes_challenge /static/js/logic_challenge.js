...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  majorQuakesData= "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson"

  d3.json(majorQuakesData).then(function(data3) {

    // 4. Use the same style as the earthquake data.
    function styleForMajor(feature) {
      return {
        opacity: 1,
        fillOpacity: 1,
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json(tectonicData).then(function(data2) {
    console.log(data2);
    L.geoJson(data2,{
      color: "red"
